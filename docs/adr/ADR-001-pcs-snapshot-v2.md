...
## Decision
Use a strict, versioned `pcs-analysis-snapshot-v2` contract at the API boundary. The snapshot carries only user-confirmed, permitted values plus provenance and exclusions.
