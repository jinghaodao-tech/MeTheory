...
export type BaselineItemMapping = { itemKey: string; construct: "task_initiation" | "task_continuation" | "social_load" | "recovery_conditions" | "attention_conditions"; comparisonRoles: string[]; direction: "higher_means_more" | "higher_means_less" };
...
export const BASELINE_ITEM_MAPPINGS: readonly BaselineItemMapping[] = [
  { itemKey: "starting_tasks", construct: "task_initiation", comparisonRoles: ["start_delay", "initiation_difficulty", "observed_behavior"], direction: "higher_means_more" },
  { itemKey: "finishing_tasks", construct: "task_continuation", comparisonRoles: ["continuation_difficulty", "completion", "observed_behavior"], direction: "higher_means_more" },
  { itemKey: "social_energy", construct: "social_load", comparisonRoles: ["fatigue", "recovery", "social_intensity"], direction: "higher_means_more" },
  { itemKey: "planning", construct: "task_initiation", comparisonRoles: ["task_clarity", "deadline_clarity", "start_delay"], direction: "higher_means_more" },
  { itemKey: "emotional_recovery", construct: "recovery_conditions", comparisonRoles: ["recovery", "fatigue", "mood"], direction: "higher_means_more" },
  { itemKey: "attention", construct: "attention_conditions", comparisonRoles: ["focus", "continuation_difficulty"], direction: "higher_means_more" }
];
