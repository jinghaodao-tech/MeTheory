...
export type TemplateField = { fieldKey: string; label: string; description?: string; inputType: TemplateInputType; valueType: TemplateValueType; required: boolean; displayOrder: number; options?: Array<{ key: string; label: string }>; minimum?: number; maximum?: number; unit?: string; sensitivity: "normal" | "sensitive"; sensitivityLevel?: SensitivityLevel; classificationSource?: ClassificationSource; prohibitedSecretRisk?: boolean; semanticRole?: SelfUnderstandingSemanticRole; semanticRoleSource?: SemanticRoleSource; semanticRoleConfidence?: number; semanticRoleConfirmed?: boolean; semanticMergeAllowed?: boolean; reason: string };
